            ...
            <li key={index} className="list-none">
              <div className="bg-custom-green rounded-lg w-[600px] h-[86px]">
                <div className="flex justify-between mb-2">
                  ...
                  <div className="flex items-center">
                    <span className="text-white text-base ml-2.5 mt-2.5 mr-2.5">
                      마감 {diffDays}일전
                    </span>
                  </div>
                </div>
                <div className="flex justify-between m-2.5">
                  ...
                  <div className="flex space-x-2.5 items-center">
                    {info.participantsCount !== info.maxParticipants ? (
                      <div className="bg-white text-green-500 border border-green-500 w-[60px] h-6 rounded-lg text-center text-xs flex items-center justify-center">
                        모집중
                      </div>
                    ) : (
                    ...
                    <button className="btn btn-xs bg-custom-pink text-white rounded-md text-center hover:bg-custom-pink-hover">
                      취소하기
                    </button>
                  </div>
                </div>
