  ...
  return (
    <footer className="footer fixed bottom-0 bg-neutral text-neutral-content p-10">
      <nav>
        ...
        <a className="link link-hover">이승민</a>
        <a className="link link-hover">방주영</a>
      </nav>
      <nav>
        <h6 className="footer-title">Backend</h6>
        <a className="link link-hover">석승민</a>
        <a className="link link-hover">김용민</a>
        <a className="link link-hover">변상화</a>
      </nav>
      <nav>
